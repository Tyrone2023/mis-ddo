                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <h4 class="header-title mb-4">My Salary History</h4><br />
                                    ...
                                    <table class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										<thead>
                                            <tr>
                                                <th>Month/Year</th>
                                                <th>Position</th>
                                                <th style="text-align:center">SG/Step</th>
										...
										<?php
										  ...
										  {
										  echo "<tr>";
                                          echo "<td>".$row->payMonth.' '.$row->payYear."</td>";
                                          echo "<td>".$row->empPosition."</td>";
                                          echo "<td style='text-align:center'>".$row->sg.'/ '.$row->step."</td>";
                                          echo "<td style='text-align:right'>".number_format($row->basicSalary,2)."</td>";
                                          echo "<td style='text-align:right'>".number_format($row->pera,2)."</td>";
										  echo "</tr>";
