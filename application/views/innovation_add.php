                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="innovation" rows="5" id="example-textarea" required></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="recipient" rows="5" id="example-textarea" required></textarea>
                                                        </div>
                                                    </div>
                                            </div>
