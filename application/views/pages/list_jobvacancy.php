                                    ...
                                    <h4 class="header-title mb-4">Job Vacancies</h4><br />
                                        ...
                                        <tr>
                                          ...
                                          <?php if($this->session->position==='Human Resource Admin' || $this->session->position==='HR Staff' || $this->session->position==='Super Admin' || $this->session->position==='asds') : ?>
                                                        ...
                                                        <a href="<?=base_url(); ?>Page/viewApplicants?jobID=<?php echo $row->jobID; ?>&jobTitle=<?php echo $row->jobTitle; ?>" class="btn btn-info tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View Applicants"><i class="mdi mdi-file-document-box-outline"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        ...
                                                        <a target="_blank" href="<?=base_url(); ?>Pages/rqa_list/<?= $row->sy; ?>?jobID=<?php echo $row->jobID; ?>&jobTitle=<?php echo $row->jobTitle; ?>" class="btn btn-success tooltips" data-placement="top" data-toggle="tooltip" data-original-title="RQA"><i class="mdi mdi-calculator"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    ?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" name="job_type">
                                                                    ...
                                                                    <?php $gt = array('Elementary' => 1,'Junior High School' => 2,'Senior High School' => 3); ?>
                                                                    <?php foreach($gt as $row=>$key){?>
                                                                    <option value="<?= $key; ?>"><?= $row; ?></option>
                                                                    <?php } ?>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select class="form-control" name="job_type">
                                                                    <option value="0"></option>
                                                                    <?php $gt = array('Elementary' => 4,'Secondary' => 5); ?>
                                                                    <?php foreach($gt as $row=>$key){?>
                                                                    <option value="<?= $key; ?>"><?= $row; ?></option>
                                                                    <?php } ?>
