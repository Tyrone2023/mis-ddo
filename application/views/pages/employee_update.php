						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="empNo" <?php if($this->session->position == "user"){echo "readonly";} ?>
							...
							<div class="row">
								...
								<div class="col-lg-1">
									<div class="form-group">
										<label>SG No.</label>
										<select class="form-control <?php if($this->session->position == 'user'){echo " readonly ";}?>" name="sgNo" >
											<option></option>
											<!-- <?php
											for ($x = 1; $x <= 33; $x += 1) {
												echo "<option";
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<select class="form-control" name="payGroup">
												<option></option>
												<?php
												$array = array('Casual', 'Elementary', 'Secondary', 'Senior High School','Provisionary','Kindergarten');
												foreach ($array as $ar) {
													echo '<option';
													if ($ar == $app->payGroup) {
														echo " selected ";
