<!-- ============================================================== -->
            ...
            <?php $rating = $this->Common->two_cond_row('hris_applications_rating','record_no',$data->record_no,'appID',$aa->appID); ?>

            <?php $inquery = $this->Common->two_cond_count_row('hris_application_inquiry','applicant_id',$this->uri->segment(3),'job_id',$this->uri->segment(4)); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background: #ceeffb;">
                                                                ...
                                                                <?php if($this->session->position === 'Human Resource Admin' || $this->session->position === 'HR Staff' || $this->session->position === 'Super Admin' || $this->session->position === 'asds'){?>
                                                                    ...
                                                                    <?php if($aa->appStatus == "Endorsed for Rating"){ ?><a onclick="return confirm('Are you sure?')" class="btn btn-purple btn-sm" href="<?= base_url(); ?>Pages/rated/<?= $this->uri->segment(3); ?>/<?= $this->uri->segment(4); ?>/<?= $this->uri->segment(5); ?>/<?= $this->uri->segment(6); ?>">Rated</a><?php } ?>
