...
<body>
    ...
    <?php if (!$data) { 
        ...
        <strong style="margin-top: 0; padding: 0;">(Purpose: <?php echo $data2[0]->purpose ?> )</strong>
</td>
                ...
                <td colspan="3" style="border: none;">
                    <div class="bottom2" style="border: none;">
                        <div class="bottom2-box">
                            ...
                            <p style="text-align: left;">BY: <?php echo $data2[0]->action_user; ?></p><br>
                            <p>DATE: 
                            <?php 
                                $date = new DateTime($data2[0]->action_date); 
                                echo $date->format('F j, Y h:iA'); 
                            ?>
                        </p>
                        </div>
                    </div>
