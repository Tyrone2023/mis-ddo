                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="oi" rows="5" id="example-textarea" required><?= $data->oi; ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="pi" rows="2" id="example-textarea" required><?= $data->pi; ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="gi" rows="5" id="example-textarea" required><?= $data->gi; ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="at" rows="5" id="example-textarea" required><?= $data->at; ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" name="issues" rows="5" id="example-textarea" required><?= $data->issues; ?></textarea>
                                                        </div>
                                                    </div>
                                            </div>
