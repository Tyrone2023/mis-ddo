                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $count = 1;
                                                        foreach($data as $row){ 
                                                        $sub = $this->SGODModel->two_cond_row('sgod_aip_submit', 'fy', $_SESSION['fy_admin'], 'school_id',$row->schoolID);
                                                        $school = $this->SGODModel->two_cond_group('sgod_aip_submit', 'fy', $_SESSION['fy_admin'], 'school_id',$row->schoolID,'school_id');
                                                        foreach($school as $s){ 
                                                        ?>
