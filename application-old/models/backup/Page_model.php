...
class Page_model extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT * FROM hris_applications a join hris_applications_rating r on a.appID=r.appID join hris_applicant ha on ha.record_no=r.record_no where jobID='" . $jobID . "' and resCity='" . $mun . "' and track='" . $spec . "' and  total_points>='50' ORDER BY total_points DESC");
        return $query->result();
    }
