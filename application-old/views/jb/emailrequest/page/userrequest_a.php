                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                        <tr>
                            ...
                            <!-- <th>𝐌𝐞𝐬𝐬𝐚𝐠𝐞:</th> -->
                            <th>𝐂𝐨𝐧𝐜𝐞𝐫𝐧:</th>
                            <th style="width: 130px;">𝐒𝐭𝐚𝐭𝐮𝐬:</th>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $row) {
                            ...
                            echo "<td style='text-align: center;'>
								<form action='" . base_url('jb_emailrequest/updaterequest') . "' method='POST' style='display:inline;'>
								...
								<form action='" . base_url('jb_emailrequest/deleterequest') . "' method='POST' style='display:inline;' class='delete-form' >
								...
								<form action='" . base_url('jb_emailrequest/setisdonetrue') . "' method='POST' style='display:inline;' class='markdonerequest-form' >
									<input type='hidden' name='update_id' value='" . $row->id . "'>
