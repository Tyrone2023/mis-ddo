                                                                            ...
                                                                            <tbody>
                                                                                <?php 
                                                                                    ...
                                                                                    foreach($question as $sub_row){
                                                                                        $ren='q'.$sub_row->i_no;
                                                                                        $sc1 = $this->Common->one_cond_count_row('sbm',$ren,1);
                                                                                        $sc2 = $this->Common->one_cond_count_row('sbm',$ren,2);
                                                                                        $sc3 = $this->Common->one_cond_count_row('sbm',$ren,3);
                                                                                        $sc4 = $this->Common->one_cond_count_row('sbm',$ren,4);
