<!-- ============================================================== -->
            ...
            <?php 
                ...
                $aa = $this->Common->two_cond_row('hris_applications','empEmail',$data->empEmail,'jobID',$this->uri->segment(4)); 
                $rating = $this->Common->two_cond_row('hris_rating_none','record_no',$data->record_no,'appID',$aa->appID); 
                                            ...
                                            <table class="table table-striped mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background: #bbecfe;"><a href="<?= base_url(); ?>Pages/ies/<?= $data->id; ?>/<?= $aa->appID; ?>/<?= $this->uri->segment(4); ?>" target="_blank" class="btn btn-info btn-sm">View</a></td>
                                                    </tr>
                                                    <?php } ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="background: #9ddcf4;">
                                                        <a href="<?= base_url(); ?>Pages/inquiry_non/<?= $data->id; ?>/<?= $job->jobID; ?>/<?= $aa->pre_school; ?>/<?= $aa->appID; ?>" class="btn btn-info btn-sm">QUERY</a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"  style="background: #90bdf9; color:#464545">
                                                            ...
                                                            <?php if($data->stat == 0){if($this->session->c_id == $user->user_id){?>
                                                    ...
                                                    <tr id="tsc">
                                                        ...
                                                        <td class="text-left" style="background: #f3d57d; color:#464545">
                                                            <?php if($data->tor_cav != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $data->id; ?>/tor_cav/?label=TOR & CAV - College / Graduate Studies" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($data->stat == 0){if($this->session->c_id == $user->user_id){?>
                                                    ...
                                                    <tr class="bg-purple text-white" id="er">
                                                        ...
                                                        <td class="text-left" style="background: #bbb7eb; color:#464545">
                                                            <?php if($data->eligibility != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $data->id; ?>/eligibility/?label=Eligibility (Attachment)" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($data->stat == 0){if($this->session->c_id == $user->user_id){?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"  style="background: #9ddcf4; color:#464545">
                                                            <?php if($data->oa != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $data->id; ?>/oa/?label=Outstanding Accomplishments" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($data->stat == 0){if($this->session->c_id == $user->user_id){?>
                                                    ...
                                                    <tr>
                                                        <th class="text-right">MOV'S (Attachments)</th>
                                                        <td class="text-left"  style="background: #90bdf9; color:#464545">
                                                            <?php if($data->ae != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $data->id; ?>/ae/?label=Application Of Education" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($data->stat == 0){if($this->session->c_id == $user->user_id){?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left"  style="background: #fde8d1; color:#464545">
                                                            <?php if($data->ald != ""){?><a href="<?= base_url(); ?>Pages/pdf/<?= $data->id; ?>/ald/?label=Application Of Learning & Development" target="_blank" class="tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment"><i  class="fas fa-file-alt btn btn-lg"></i></a><?php } ?>
                                                            <?php if($data->stat == 0){if($this->session->c_id == $user->user_id){?>
                                                    ...
                                                    <?php if($rating->skills != 0.00001 || $this->session->position == 'asds'){  ?>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <div class="col-lg-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="jhss"  value="<?= $data->jhss; ?>" >
                                                                                </div>	
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                                <div class="form-group">
                                                                                    <label>Senior HS Specialization</label>
                                                                                    <input type="text" class="form-control" name="shss"  value="<?= $data->shss; ?>" >
                                                                                </div>	
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <option <?php if($data->asht == "0"){echo "selected";} ?> value="0">Classroom Teacher</option>
                                                                                    <option <?php if($data->asht == "1"){echo "selected";} ?> value="1">School Head</option>
                                                                                    <option <?php if($data->asht == "2"){echo "selected";} ?> value="2">Detailed as Assistant SP</option>
                                                                                </select>
                                                                                </div>	
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="cp"  value="<?= $data->empPosition; ?>" >
                                                                                </div>	
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    ...
                                                                    <input type="hidden" name="record" value="<?= $data->record_no; ?>">
