                            ...
                            <div class="col-12">
                                <div class="page-title-box">
                                    <?php if($this->session->position==='Human Resource Admin' || $this->session->position==='HR Staff' || $this->session->userdata('position')==='Super Admin' || $this->session->position==='asds'): ?>
                                        <a href="<?= base_url(); ?>Pages/hiring_non_qaulified" target="_blank" class="btn btn-info">Qalified List</a>
                                        <a href="<?= base_url(); ?>Pages/hiring_non_not_qaulified" target="_blank" class="btn btn-success">Not Qalified List</a>
                                            ...
                                            //if(isset($a)){ 
                                                ...
                                                <td><?= $row->dateSubmitted; ?></td>
                                                    <td>
                                                        ...
                                                        <a target="_blank" href="<?= base_url(); ?>pages/<?php echo !empty($b) ? 'ma' : 'ma_staff'; ?>/<?php echo !empty($b) ? $a->id : $a->IDNumber; ?>/<?= $row->jobID; ?>/<?= $row->pre_school; ?>/<?= $row->appID; ?>/<?php echo !empty($b) ? $a->record_no : $a->IDNumber; ?>/" class="text-success tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View Applicant Information"><i class="fas fa-file-alt"></i></a>&nbsp; &nbsp;
                                                  
                                                    <?php if($this->session->position == 'doceval' || $this->session->position == 'asds'){?>
                                                        <?php $ren = !empty($b) ? $a->id : $a->IDNumber; ?>
                                                       <?php 
