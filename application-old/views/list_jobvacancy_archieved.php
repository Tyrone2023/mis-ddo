                                    ...
                                    <h4 class="header-title mb-4">Job Vacancies</h4><br />
                                        ...
                                        //   echo "<td>".$row->postedBy."</td>";
                                          ...
                                          <td>
                                            ...
                                            <a href="<?=base_url(); ?>Page/rqa?jobID=<?php echo $row->jobID; ?>&jobTitle=<?php echo $row->jobTitle; ?>" class="text-primary tooltips" data-placement="top" data-toggle="tooltip" data-original-title="RQA"><i class="mdi mdi-calculator"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
