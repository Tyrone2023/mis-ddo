                                        ...
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <td><?= $row->memoNo; ?></td>
                                                    ...
                                                    <?php } else { ?>
                                                        <a class="btn btn-warning btn-sm tooltips" data-placement="top" data-toggle="tooltip" data-original-title="Update File Attachment" href="<?= base_url(); ?>page/memo_file_update/<?= $row->id; ?>"><i class="fas fa-file-pdf"></i></a>   
                                                        <a class="btn btn-success btn-sm tooltips" data-placement="top" data-toggle="tooltip" data-original-title="View File Attachment" href="<?= base_url(); ?>uploads/memo/<?= $row->fileName; ?>" target="_blank"><i class="fas fa-file-pdf"></i></a>
                                                    <?php } ?> 
