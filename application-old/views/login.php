                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            <div class="card-header p-4 bg-primary">
                                <h4 class="text-white text-center mb-0 mt-0"><img  width="300" src="<?= base_url(); ?>assets/images/logo.png" alt=""></h4>
                            </div>
                            <div class="card-body">
                                ...
                                <?= form_open('log_in') ?>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="checkbox checkbox-success">
                                            ...
                                            <a href="new_applicant" class="text-muted float-right">Create an Account/Register</a>
