...
<html lang="en">
    ...
    <table width="100%">
        ...
        ?>
            ...
            <tr>
                ...
                <th colspan="2" class="nobc"><?= number_format(($monthly*$mb), 2, '.', ','); ?></th><?php $mbmc = (double)$monthly*(double)$mb; ?>
            </tr>
            <tr>
            ...
            <?php $tq = (double)$approw->qjan+(double)$approw->qfeb+(double)$approw->qmar+(double)$approw->qapril+(double)$approw->qmay+(double)$approw->qjune+(double)$approw->qjuly+(double)$approw->qaug+(double)$approw->qsept+(double)$approw->qoct+(double)$approw->qnov+(double)$approw->qdec; ?>
                ...
                <tr>
                    ...
                    <?php 
                        ...
                        $mbmtdec = (double)$approw->dec*(double)$approw->qdec;
                    ...
                    <td><?php $mbmtdec = (double)$approw->dec*(double)$approw->qdec; echo number_format($mbmtdec); ?></td>
        ...
        <?php } ?>
            ...
            <tr>
                ...
                <td class="t"><?php if($otjan > $mrmc){echo "green";}else{echo "red";}?>  <?= $otjan; ?> > <?= $mrmc; ?></td>
                <td class="t"></td>
                <td class="t"></td>
                <td class="t"><?= number_format($otba); ?></td>
        ...
        <?php } ?>
            ...
            <tr>
                ...
                <td class="t"></td>
                <td class="t"><?= number_format($otba); ?></td>
                <td class="t <?php if(number_format($otjan) > number_format($tlimc)){echo "red";}elseif(number_format($otjan) == number_format($tlimc)){echo "green";}?>"><?= number_format($otjan); ?></td><?php $tijan = $otjan; ?>
                <td class="t <?php if(number_format($otfeb) > number_format($tlimc)){echo "red";}elseif(number_format($otfeb) == number_format($tlimc)){echo "green";}?>"><?= number_format($otfeb); ?></td><?php $tifeb = $otfeb; ?>
                <td class="t <?php if(number_format($otmar) > number_format($tlimc)){echo "red";}elseif(number_format($otmar) == number_format($tlimc)){echo "green";}?>"><?= number_format($otmar); ?></td><?php $timar = $otmar; ?>
                <td class="t"><?= number_format($otfq); ?></td><?php $tifq = $otfq; ?>
                <td class="t <?php if(number_format($otapril) > number_format($tlimc)){echo "red";}elseif(number_format($otapril) == number_format($tlimc)){echo "green";}?>"><?= number_format($otapril); ?></td><?php $tiapril = $otapril; ?>
                <td class="t <?php if(number_format($otmay) > number_format($tlimc)){echo "red";}elseif(number_format($otmay) == number_format($tlimc)){echo "green";}?>"><?= number_format($otmay); ?></td><?php $timay = $otmay; ?>
                <td class="t <?php if(number_format($otjune) > number_format($tlimc)){echo "red";}elseif(number_format($otjune) == number_format($tlimc)){echo "green";}?>"><?= number_format($otjune); ?></td><?php $tijune = $otjune; ?>
                <td class="t"><?= number_format($otsq); ?></td><?php $tisq = $otsq; ?>
                <td class="t <?php if(number_format($otjuly) > number_format($tlimc)){echo "red";}elseif(number_format($otjuly) == number_format($tlimc)){echo "green";}?>"><?= number_format($otjuly); ?></td><?php $tijuly = $otjuly; ?>
                <td class="t <?php if(number_format($otaug) > number_format($tlimc)){echo "red";}elseif(number_format($otjan) == number_format($otaug)){echo "green";}?>"><?= number_format($otaug); ?></td><?php $tiaug = $otaug; ?>
                <td class="t <?php if(number_format($otsept) > number_format($tlimc)){echo "red";}elseif(number_format($otsept) == number_format($tlimc)){echo "green";}?>"><?= number_format($otsept); ?></td><?php $tisept = $otsept; ?>
                <td class="t"><?= number_format($ottq); ?></td><?php $titq = $ottq; ?>
                <td class="t <?php if(number_format($otoct) > number_format($tlimc)){echo "red";}elseif(number_format($otoct) == number_format($tlimc)){echo "green";}?>"><?= number_format($otoct); ?></td><?php $tioct = $otoct; ?>
                <td class="t <?php if(number_format($otnov) > number_format($tlimc)){echo "red";}elseif(number_format($otnov) == number_format($tlimc)){echo "green";}?>"><?= number_format($otnov); ?></td><?php $tinov = $otnov; ?>
                <td class="t <?php if(number_format($otdec) > number_format($tlimc)){echo "red";}elseif(number_format($otdec) == number_format($tlimc)){echo "green";}?>"><?= number_format($otdec); ?></td><?php $tidec = $otdec; ?>
        ...
        <?php } ?>
            ...
            <tr>
                ...
                <td class="t"></td>
                <td class="t"><?= number_format($otba); ?></td>
                <td class="t <?php if(number_format($otjan) > number_format($tstmc)){echo "red";}elseif(number_format($otjan) == number_format($tstmc)){echo "green";}?>"><?= number_format($otjan); ?></td><?php $majan = $otjan; ?>
                <td class="t <?php if(number_format($otfeb) > number_format($tstmc)){echo "red";}elseif(number_format($otfeb) == number_format($tstmc)){echo "green";}?>"><?= number_format($otfeb); ?></td><?php $mafeb = $otfeb; ?>
                <td class="t <?php if(number_format($otmar) > number_format($tstmc)){echo "red";}elseif(number_format($otmar) == number_format($tstmc)){echo "green";}?>"><?= number_format($otmar); ?></td><?php $mamar = $otmar; ?>
                <td class="t"><?= number_format($otfq); ?></td><?php $mafq = $otfq; ?>
                <td class="t <?php if(number_format($otapril) > number_format($tstmc)){echo "red";}elseif(number_format($otapril) == number_format($tstmc)){echo "green";}?>"><?= number_format($otapril); ?></td><?php $maapril = $otapril; ?>
                <td class="t <?php if(number_format($otmay) > number_format($tstmc)){echo "red";}elseif(number_format($otmay) == number_format($tstmc)){echo "green";}?>"><?= number_format($otmay); ?></td><?php $mamay = $otmay; ?>
                <td class="t <?php if(number_format($otjune) > number_format($tstmc)){echo "red";}elseif(number_format($otjune) == number_format($tstmc)){echo "green";}?>"><?= number_format($otjune); ?></td><?php $majune = $otjune; ?>
                <td class="t"><?= number_format($otsq); ?></td><?php $masq = $otsq; ?>
                <td class="t <?php if(number_format($otjuly) > number_format($tstmc)){echo "red";}elseif(number_format($otjuly) == number_format($tstmc)){echo "green";}?>"><?= number_format($otjuly); ?></td><?php $majuly = $otjuly; ?>
                <td class="t <?php if(number_format($otaug) > number_format($tstmc)){echo "red";}elseif(number_format($otaug) == number_format($tstmc)){echo "green";}?>"><?= number_format($otaug); ?></td><?php $maaug = $otaug; ?>
                <td class="t <?php if(number_format($otsept) > number_format($tstmc)){echo "red";}elseif(number_format($otsept) == number_format($tstmc)){echo "green";}?>"><?= number_format($otsept); ?></td><?php $masept = $otsept; ?>
                <td class="t"><?= number_format($ottq); ?></td><?php $matq = $ottq; ?>
                <td class="t <?php if(number_format($otoct) > number_format($tstmc)){echo "red";}elseif(number_format($otoct) == number_format($tstmc)){echo "green";}?>"><?= number_format($otoct); ?></td><?php $maoct = $otoct; ?>
                <td class="t <?php if(number_format($otnov) > number_format($tstmc)){echo "red";}elseif(number_format($otnov) == number_format($tstmc)){echo "green";}?>"><?= number_format($otnov); ?></td><?php $manov = $otnov; ?>
                <td class="t <?php if(number_format($otdec) > number_format($tstmc)){echo "red";}elseif(number_format($otdec) == number_format($tstmc)){echo "green";}?>"><?= number_format($otdec); ?></td><?php $madec = $otdec; ?>
            ...
            <tr>
                ...
                <td class="ot"><a class="a <?php if(number_format($ojan) > number_format($monthly)){echo "red";}elseif(number_format($ojan) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/jan" target="_blank"><?= number_format($ojan); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($ofeb) > number_format($monthly)){echo "red";}elseif(number_format($ofeb) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/feb" target="_blank"><?= number_format($ofeb); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($omay) > number_format($monthly)){echo "red";}elseif(number_format($omay) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/mar" target="_blank"><?= number_format($omar); ?></a></td>
                <td class="ot "><b><?= number_format($mafq+$tifq+$mrfq+$mbfq); ?></b></td>
                <td class="ot"><a class="a <?php if(number_format($oapril) > number_format($monthly)){echo "red";}elseif(number_format($oapril) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/april" target="_blank"><?= number_format($oapril); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($omay) > number_format($monthly)){echo "red";}elseif(number_format($omay) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/may" target="_blank"><?= number_format($omay); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($ojune) > number_format($monthly)){echo "red";}elseif(number_format($ojune) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/june" target="_blank"><?= number_format($ojune); ?></a></td>
                <td class="ot"><b><?= number_format($masq+$tisq+$mrsq+$mbsq); ?></b></td>
                <td class="ot"><a class="a <?php if(number_format($ojuly) > number_format($monthly)){echo "red";}elseif(number_format($ojuly) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/july" target="_blank"><?= number_format($ojuly); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($oaug) > number_format($monthly)){echo "red";}elseif(number_format($oaug) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/aug" target="_blank"><?= number_format($oaug); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($osept) > number_format($monthly)){echo "red";}elseif(number_format($osept) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/sept" target="_blank"><?= number_format($osept); ?></a></td>
                <td class="ot"><b><?= number_format($matq+$titq+$mrtq+$mbtq); ?></b></td>
                <td class="ot"><a class="a <?php if(number_format($ooct) > number_format($monthly)){echo "red";}elseif(number_format($ooct) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/oct" target="_blank"><?= number_format($ooct); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($onov) > number_format($monthly)){echo "red";}elseif(number_format($onov) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/nov" target="_blank"><?= number_format($onov); ?></a></td>
                <td class="ot"><a class="a <?php if(number_format($odec) > number_format($monthly)){echo "red";}elseif(number_format($odec) == number_format($monthly)){echo "g";}?>" href="generate_rcav2/dec" target="_blank"><?= number_format($odec); ?></a></td>
    ...
    <div class="fcon">
                <img style="width:90px; float:left;" src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=<?= base_url(); ?>Page/aip_admin/<?= $data_row->school_id.'/'.$data_row->fy.'/'.$data_row->b_code.'/'.$data_row->id; ?>" title="" />
                <div class="lcon">
