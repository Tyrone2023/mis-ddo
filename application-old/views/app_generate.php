    ...
    <table width="100%">
        ...
        <?php } ?>
            ...
            <tr>
                ...
                <td class="t"></td>
                <td class="t"><?= number_format($otba); ?></td>
                <td class="t <?php if((int)$otjan > (int)$mrmc){echo "red";}elseif(number_format($otjan) === number_format($mrmc)){echo "green";}?>"><?= number_format($otjan); ?></td><?php $mrjan = $otjan; ?>
                <td class="t <?php if((int)$otfeb > (int)$mrmc){echo "red";}elseif(number_format($otfeb) === number_format($mrmc)){echo "green";}?>"><?= number_format($otfeb); ?></td><?php $mrfeb = $otfeb; ?>
                <td class="t <?php if((int)$otmar > (int)$mrmc){echo "red";}elseif(number_format($otmar) === number_format($mrmc)){echo "green";}?>"><?= number_format($otmar); ?></td><?php $mrmar = $otmar; ?>
                <td class="t"><?= number_format($otfq); ?></td><?php $mrfq = $otfq; ?>
                <td class="t <?php if((int)$otapril > (int)$mrmc){echo "red";}elseif(number_format($otapril) === number_format($mrmc)){echo "green";}?>"><?= number_format($otapril); ?></td><?php $mrapril = $otapril; ?>
                <td class="t <?php if((int)$otmay > (int)$mrmc){echo "red";}elseif(number_format($otmay) === number_format($mrmc)){echo "green";}?>"><?= number_format($otmay); ?></td><?php $mrmay = $otmay; ?>
                <td class="t <?php if((int)$otjune > (int)$mrmc){echo "red";}elseif(number_format($otjune) === number_format($mrmc)){echo "green";}?>"><?= number_format($otjune); ?></td><?php $mrjune = $otjune; ?>
                <td class="t"><?= number_format($otsq); ?></td><?php $mrsq = $otsq; ?>
                <td class="t <?php if((int)$otjuly > (int)$mrmc){echo "red";}elseif(number_format($otjuly) === number_format($mrmc)){echo "green";}?>"><?= number_format($otjuly); ?></td><?php $mrjuly = $otjuly; ?>
                <td class="t <?php if((int)$otaug > (int)$mrmc){echo "red";}elseif(number_format($otaug) === number_format($mrmc)){echo "green";}?>"><?= number_format($otaug); ?></td><?php $mraug = $otaug; ?>
                <td class="t <?php if((int)$otsept > (int)$mrmc){echo "red";}elseif(number_format($otsept) === number_format($mrmc)){echo "green";}?>"><?= number_format($otsept); ?></td><?php $mrsept = $otsept; ?>
                <td class="t"><?= number_format($ottq); ?></td><?php $mrtq = $ottq; ?>
                <td class="t <?php if((int)$otoct > (int)$mrmc){echo "red";}elseif(number_format($otoct) === number_format($mrmc)){echo "green";}?>"><?= number_format($otoct); ?></td><?php $mroct = $otoct; ?>
                <td class="t <?php if((int)$otnov > (int)$mrmc){echo "red";}elseif(number_format($otnov) === number_format($mrmc)){echo "green";}?>"><?= number_format($otnov); ?></td><?php $mrnov = $otnov; ?>
                <td class="t <?php if((int)$otdec > (int)$mrmc){echo "red";}elseif(number_format($otdec) === number_format($mrmc)){echo "green";}?>"><?= number_format($otdec); ?></td><?php $mrdec = $otdec; ?>
