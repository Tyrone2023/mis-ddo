                                            ...
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        $count = 1;
                                                        foreach($data as $row){ 
                                                        $sub = $this->SGODModel->two_cond_row('sgod_aip_submit', 'fy', '2024', 'school_id',$row->schoolID,'remarks','Approved');
                                                        $school = $this->SGODModel->three_cond('sgod_aip_submit', 'fy', '2024', 'school_id',$row->schoolID,'remarks','Approved');
                                                        foreach($school as $s){ 
