...
<html lang="en">
    ...
    <body class="aip_generate" id="printTable">
        ...
        <div class="cert">
            ...
            <p class="text-justify" style="margin-bottom:10px; text-indent: 50px;">for having successfully complied with and met the requirements and standards set forth by the Department of Education, in accordance with DepEd Order 44, s.2015. Furthermore, the school demonstrated strict adherence to the implementing Guidelines on the Direct Release, Use, Monitoring and Reporting of Supplemental Fund for  Special Needs Education (SNED) Allocation of Schools, as well as, the management of other funds, for the Fiscal Year <?= date('Y', strtotime($a->tdate)); ?>, as stipulated in Deped Order No. 8,s. 2019.</p>
