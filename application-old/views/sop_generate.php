        ...
        <tbody>
            ...
            <?php if($sp !== $row->sip_project) { ?>
                ...
                <?php 
                  ...
                  if(!empty($ft)){
                ?>
                <td><?php if($ft->q1){echo number_format($ft->q1);}  ?></td>
                <td><?php if($ft->q2){echo number_format($ft->q2);}  ?></td>
                <td><?php if($ft->q3){echo number_format($ft->q3);}  ?></td>
                <td><?php if($ft->q4){echo number_format($ft->q4);}  ?></td>
                <td><?php if($ft->total){echo number_format($ft->total);} ?></td>
                <?php }else{?>
                    <td></td><td></td><td></td><td></td><td></td>
                <?php } ?>
                ...
                <?php 
                  ...
                  if(!empty($fto)){
                ?>
                <td><?php if($fto->q1){echo number_format($fto->q1);} ?></td>
                <td><?php if($fto->q2){echo number_format($fto->q2);} ?></td>
                <td><?php if($fto->q3){echo number_format($fto->q3);} ?></td>
                <td><?php if($fto->q4){echo number_format($fto->q4);} ?></td>
