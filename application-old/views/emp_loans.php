                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <h4 class="header-title mb-4">CURRENT LOANS AND OTHER DEDUCTIONS</h4><br />
                                       
                                    <table class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										<thead>
                                            <tr>
                                                <th>PLI/GFI</th>
                                                <th style="text-align:center">Ded. Code</th>
                                                <th style="text-align:center">Effectivity</th>
                                                <th style="text-align:center">Termination</th>
                                                <th>Deducted Amount</th>
                                                <th>Principal Amount</th>
                                                <th style="text-align:center">Ded. Status</th>
											</tr>
                                        </thead>
                                        <tbody>
										...
										<?php
										  ...
										  {
										  echo "<tr>";
                                          echo "<td>".$row->dedAgency."</td>";
                                          echo "<td style='text-align:center'>".$row->dedCode."</td>";
                                          echo "<td style='text-align:center'>".$row->effectivity."</td>";
                                          echo "<td style='text-align:center'>".$row->termination."</td>";
                                          echo "<td style='text-align:right;'>".number_format($row->dedAmount,2)."</td>";
                                          echo "<td style='text-align:right;'>".number_format($row->principalAmount,2)."</td>";
                                          echo "<td style='text-align:center'>".$row->dedStatus."</td>";
										  echo "</tr>";
